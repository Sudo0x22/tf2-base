...
ImVec4 To_Imvec4(float r, float g, float b, float a)
{
    return ImVec4(r / 255.0, g / 255.0, b / 255.0, a / 255.0);
}

ImColor To_Imcolor(float r, float g, float b, float a)
{
    return ImVec4(r / 255.0, g / 255.0, b / 255.0, a / 255.0);
}
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x + 6, check_bb.Min.y + 9), 7, GetColorU32(Col_Off), 12);
    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x + 5, check_bb.Min.y + 9), 7, GetColorU32(Col_Off), 12);
    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x + 4, check_bb.Min.y + 9), 7, GetColorU32(Col_Off), 12);
    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x + 3, check_bb.Min.y + 9), 7, GetColorU32(Col_Off), 12);
    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x + 2, check_bb.Min.y + 9), 7, GetColorU32(Col_Off), 12);
    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x + 1, check_bb.Min.y + 9), 7, GetColorU32(Col_Off), 12);
    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x / x, check_bb.Min.y + 9), 7, GetColorU32(Col_Off), 12);
    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x - 1, check_bb.Min.y + 9), 7, GetColorU32(Col_Off), 12);
    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x - 2, check_bb.Min.y + 9), 7, GetColorU32(Col_Off), 12);
    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x - 3, check_bb.Min.y + 9), 7, GetColorU32(Col_Off), 12);
    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x - 4, check_bb.Min.y + 9), 7, GetColorU32(Col_Off), 12);
    ...
    if (*v)
    {
        ...
        //window-> DrawList- >AddRectFilled(ImVec2(check_bb.Min.x + / (check_bb.Max.x - check_bb.Min.x) / 2, check_bb.Min.y), check_bb.Max, GetColorU32 (ImVec4 (0.34 f, 1.0f, 0.54f, 1.0f), 0);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x + 6, check_bb.Min.y + 9), 7, GetColorU32(Col_On), 12);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x + 5, check_bb.Min.y + 9), 7, GetColorU32(Col_On), 12);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x + 4, check_bb.Min.y + 9), 7, GetColorU32(Col_On), 12);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x + 3, check_bb.Min.y + 9), 7, GetColorU32(Col_On), 12);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x + 2, check_bb.Min.y + 9), 7, GetColorU32(Col_On), 12);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x + 1, check_bb.Min.y + 9), 7, GetColorU32(Col_On), 12);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x / x, check_bb.Min.y + 9), 7, GetColorU32(Col_On), 12);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x - 1, check_bb.Min.y + 9), 7, GetColorU32(Col_On), 12);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x / x - 2, check_bb.Min.y + 9), 7, GetColorU32(Col_On), 12);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x - 3, check_bb.Min.y + 9), 7, GetColorU32(Col_On), 12);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x - 4, check_bb.Min.y + 9), 7, GetColorU32(Col_On), 12);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x - 5, check_bb.Min.y + 9), 7, GetColorU32(Col_On), 12);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x - 6, check_bb.Min.y + 9), 7, GetColorU32(Col_On), 12);
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x + 6, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(1.0f, 1.0f, 1.0f, 1.0f)), 12);
    }
    else
    {
        window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + x - 6, check_bb.Min.y + 9), 7, GetColorU32(ImVec4(1.0f, 1.0f, 1.0f, 1.0f)), 12);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    const float w = 100; // (flags & ImGuiComboFlags_NoPreview) ? arrow_size : expected_w
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, float power)
{
    ...
    ImVec2 erased_height = ImVec2(0.0f, 0.0f);
    erased_height.y = (frame_bb.Max.y - frame_bb.Min.y) * 0.005f * (100.0f - 5.0f);
...
bool ImGui::BeginBottomMenuBar()
{
    ImGuiContext& g = *GImGui;
    g.NextWindowData.MenuBarOffsetMinVal = ImVec2(g.Style.DisplaySafeAreaPadding.x, ImMax(g.Style.DisplaySafeAreaPadding.y - g.Style.FramePadding.y, 0.0f));
    // g.Style.DisplaySafeAreaPadding = ImVec2(100,100);
    SetNextWindowPos(ImVec2(0.0f, g.IO.DisplaySize.y), 0, ImVec2(0.0f, 1.0f));
    SetNextWindowSize(ImVec2(g.IO.DisplaySize.x, g.NextWindowData.MenuBarOffsetMinVal.y + g.FontBaseSize + g.Style.FramePadding.y));
    PushStyleVar(ImGuiStyleVar_WindowRounding, 0.0f);
    PushStyleVar(ImGuiStyleVar_WindowMinSize, ImVec2(0, 0));
    ImGuiWindowFlags window_flags = ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_MenuBar;
    bool is_open = Begin("##BottomMainMenuBar", NULL, window_flags) && BeginMenuBar();
    PopStyleVar(2);
    g.NextWindowData.MenuBarOffsetMinVal = ImVec2(0.0f, 0.0f);
    if (!is_open)
    {
