...
namespace vgui
{
	...
	public:
		...
		virtual IHTML* CreateHTMLWindow(vgui::IHTMLEvents* events, unsigned int context) = 0;
		...
		virtual void SetAsTopMost(unsigned int panel, bool state) = 0;
		virtual void BringToFront(unsigned int panel) = 0;
		virtual void SetForegroundWindow(unsigned int panel) = 0;
		virtual void SetPanelVisible(unsigned int panel, bool state) = 0;
		virtual void SetMinimized(unsigned int panel, bool state) = 0;
		virtual bool IsMinimized(unsigned int panel) = 0;
		virtual void FlashWindow(unsigned int panel, bool state) = 0;
		virtual void SetTitle(unsigned int panel, const wchar_t* title) = 0;
		virtual void SetAsToolBar(unsigned int panel, bool state) = 0;		// removes the window's task bar entry (for context menu's, etc.)
		...
		virtual unsigned int GetModalPanel() = 0;

		virtual void UnlockCursor() = 0;
		virtual void LockCursor() = 0;
		virtual void SetTranslateExtendedKeys(bool state) = 0;
		virtual unsigned int GetTopmostPopup() = 0;
		...
		// notify icons?!?
		virtual unsigned int GetNotifyPanel() = 0;
		virtual void SetNotifyIcon(unsigned int context, HTexture icon, unsigned int panelToReceiveMessages, const char* text) = 0;
		...
		// From the Xbox
		//virtual void SetPanelForInput(unsigned int unsigned int) = 0;
